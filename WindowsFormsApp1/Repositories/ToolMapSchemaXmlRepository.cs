...
{
    public sealed class ToolMapSchemaXmlRepository : IToolMapSchemaRepository
    {
        private readonly XmlDatabase _db;

        public ToolMapSchemaXmlRepository(string filePath)
        {
            // If ToolMap XML uses namespaces, register here:
            XmlNamespaceManager nsMgr = null;
            // Example (uncomment & adjust):
            // var nameTable = new NameTable();
            // nsMgr = new XmlNamespaceManager(nameTable);
            // nsMgr.AddNamespace("tm", "http://your/toolmap/namespace");
